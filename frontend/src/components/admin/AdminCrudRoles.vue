    ...
    <div class="bg-white rounded-lg w-full max-w-md max-h-[90vh] overflow-y-auto">
      ...
      <form @submit.prevent="saveItem" class="p-4 space-y-4">
        <div>
          ...
          <input v-model="form.name" type="text" required :class="['w-full px-3 py-2 border border-gray-300 rounded-md', getStatusNameColorClass(form.status)]" placeholder="z.B. Schiedsrichter:in" />
        </div>
        <div>
