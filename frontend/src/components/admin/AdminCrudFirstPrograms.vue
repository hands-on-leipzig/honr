...
async function handleLogoSelect(event: Event) {
  ...
  try {
    ...
    const response = await apiClient.post(`/admin/first-programs/${editingItem.value.id}/logo`, formData, {
...
async function deleteLogo() {
  ...
  try {
    await apiClient.delete(`/admin/first-programs/${editingItem.value.id}/logo`)
