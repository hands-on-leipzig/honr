...
SVG;
    ...
    private function getIconForRole(string $roleName): string
    {
        ...
        $icons = [
            ...
            // Ober-Schiedsrichter:in - Same as Schiedsrichter:in but with black hat
            'Ober-Schiedsrichter:in' => '<g class="icon-fill" fill="#000000"><ellipse cx="32" cy="10" rx="10" ry="4"/><rect x="22" y="10" width="20" height="3" rx="1"/></g><g class="icon-fill" fill="#FBBF24"><circle cx="32" cy="18" r="7"/></g><g class="icon-fill" fill="#ffffff"><path d="M 18 36 Q 18 30 32 30 Q 46 30 46 36 L 46 50 L 18 50 Z"/></g><g class="icon-fill" fill="#000000"><rect x="18" y="30" width="3" height="20"/><rect x="24" y="30" width="3" height="20"/><rect x="30" y="30" width="3" height="20"/><rect x="36" y="30" width="3" height="20"/><rect x="42" y="30" width="3" height="20"/></g>',
